...
class TestEmailField(MongoDBAsyncTestCase):
    ...
    async def test_email_field_unicode_user(self):
        class User(Document):
            email = EmailField()
    ...
    async def test_email_field_domain_whitelist(self):
        class User(Document):
            email = EmailField()
    ...
    async def test_email_domain_validation_fails_if_invalid_idn(self):
        class User(Document):
            email = EmailField()
    ...
    async def test_email_field_ip_domain(self):
        class User(Document):
            email = EmailField()
    ...
    async def test_email_field_honors_regex(self):
        class User(Document):
