...
class TestQueryset(unittest.TestCase):
    ...
    def test_distinct_handles_references(self):
        ...
        assert Foo.objects.select_related("bar").distinct("bar") == [bar]
        assert Foo.objects.distinct("bar") == [bar.pk]
    ...
    def test_upsert_includes_cls(self):
        ...
        assert "_cls" not in Test._get_collection().find_one()
        ...
        Test.objects(test="foo").update_one(upsert=True, set__test="foo")
        assert "_cls" in Test._get_collection().find_one()
    ...
    def test_no_dereference(self):
        ...
        assert isinstance(qs.first().organization, DBRef)
    ...
    def test_no_dereference_no_side_effect_on_existing_instance(self):
        ...
        qs = User.objects().select_related("organization", "organization_gen")
        user = qs.first()

        qs_no_deref = User.objects()
