...
class TestField(MongoDBTestCase):
    ...
    def test_reference_miss(self):
        ...
        foo.delete()
        bar = Bar.objects.select_related("ref", "generic_ref").get()
    ...
    def test_reference_class_with_abstract_parent(self):
        ...
        assert Brother.objects.select_related("sibling")[0].sibling.name == sister.name
...
class TestUtils(MongoDBTestCase):
    def test__no_dereference_for_fields(self):
        ...
        group = Group.objects.select_related("member").first()
