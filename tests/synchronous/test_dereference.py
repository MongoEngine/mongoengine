...
class FieldTest(unittest.TestCase):
    ...
    def test_list_item_dereference(self):
        ...
        with query_counter() as q:
            ...
            len(group_obj.select_related("members").members)
            assert q == 2
        ...
        with query_counter() as q:
            ...
            group_obj = Group.objects.first().select_related("members")
            assert q == 2
            _ = [m for m in group_obj.members]
            assert q == 2
        ...
        with query_counter() as q:
            assert q == 0
            group_objs = Group.objects.select_related("members")
            assert q == 0
    ...
    def test_list_item_dereference_dref_false(self):
        ...
        with query_counter() as q:
            ...
            _ = [m for m in group_obj.select_related("members").members]
            assert q == 2
    ...
    def test_handle_old_style_references(self):
        ...
        group = Group.objects.select_related("members").first()
    ...
    def test_migrate_references(self):
        ...
        group = Group.objects.select_related("author", "members").first()
    ...
    def test_recursive_reference(self):
        ...
        with query_counter() as q:
            ...
            peter = Employee.objects.select_related("boss", "friends").with_id(peter.id)
            assert q == 1
        ...
        with query_counter() as q:
            ...
            peter = Employee.objects.with_id(peter.id).select_related("boss", "friends")
            assert q == 2
        ...
        with query_counter() as q:
            ...
            employees = Employee.objects(boss=bill).select_related("boss", "friends")
            assert q == 0
    ...
    def test_generic_reference(self):
        ...
        with query_counter() as q:
            ...
            group_objs = list(Group.objects.select_related("members"))
            assert q == 1
    ...
    def test_generic_reference_orphan_dbref(self):
        ...
        user = UserA.objects[0]
        user.delete()
        with query_counter() as q:
            assert q == 0

            group_obj = Group.objects.select_related("members").first()
            assert q == 1
    ...
    def test_dict_field(self):
        ...
        with query_counter() as q:
            ...
            group_obj = Group.objects.first()
            assert q == 1
            group_obj.select_related("members")
            assert q == 2
    ...
    def test_multidirectional_lists(self):
        ...
        root = root.select_related("children")
    ...
    def test_document_reload_reference_integrity(self):
        ...
        msg = Message.objects.select_related("author").get(id=1)
    ...
    def test_objectid_reference_across_databases(self):
        ...
        assert isinstance(book.author.fetch(), User)
    ...
    def test_select_related_follows_embedded_referencefields(self):
        ...
        with query_counter() as q:
            ...
            playlist = Playlist.objects.select_related("items__song").first()
